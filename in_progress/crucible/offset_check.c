...
main(int argc, char **argv)
{
     ...
     *
     * Therefore a filename such as some_target_path/Dz/ac.dat will
     * have values :
     *
     *     dfl = 3  for the uppercase letter 'D'
     *     dsl = 51 for the lowercase letter 'z'
     *     ffl = 26 for the lowercase letter 'a'
     *     fsl = 28 for the lowercase letter 'c'
     *
     * However for a reasonable test we should consider the very small
     ...
     *
     * Note that the countable range of values for fsl will be 1.
     *
