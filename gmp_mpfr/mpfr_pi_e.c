...
/* mpfr_pi_e.c   Exercise the libgmp and libmpfr version report
 *               options and flags. Then a computation of pi and
 *               Eulers number e with the provided mpfr calls.
 *               Compute arctan(1) and then multiply by 4 with
 *               which should give us pi also. Then check for
 *               correct results where reasonable.
 *
