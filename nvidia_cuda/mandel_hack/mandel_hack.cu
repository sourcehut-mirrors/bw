 ...
 * up front. Not sure yet.  20200516094734
 *
...
int main(int argc, char *argv[])
{
    ...
    for (int i = 0; i < num_elements; ++i) {
        ...
        /* note : at some point we need to run a large test
         * with data b=8192 m=8388608 (-1.5018879696731058e+00, -2.1867454051976436e-05)
         *
         * a trivial case at b=8192 m=256 ( -1.50, 0.00 )
         */
