...
CFLAGS_ND=\-m64\ \-std=iso9899:1999\ \-pedantic\ \-fno-builtin\ \-O0\ \
\-mcpu=970\ \-mcall-freebsd\ \-mno-altivec\ \-mno-isel\ \-mno-paired\ \
\-mno-vsx\ \-mno-crypto\ \-mno-htm\ \-mno-quad-memory-atomic\ \
\-mno-float128\ \-mno-float128-hardware\ \-mfull-toc\ \-mdouble-float\ \
\-mno-multiple\ \-mupdate\ \-mno-avoid-indexed-addresses\ \
...
/usr/bin/printf "\nCreate a non-debug assembly output file\n"
$CC $CFLAGS_ND $CPPFLAGS -S -o ctime.s ctime.c

ls -lap ctime.s

/usr/bin/printf "\nObject code and binary are debug enabled\n"
$CC $CFLAGS $CPPFLAGS -c -o ctime.o ctime.c

ls -lap ctime.o

$CC $CFLAGS $CPPFLAGS -o ctime ctime.o
