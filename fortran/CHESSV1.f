...
C     ******************************************************************
  ...
  100 CONTINUE
      ...
      WGAME(12)=4
C     WGAME(13)='K'
C     FOR SOME OBSCURE REASON THE 13TH ELEMENT WAS A LETTER 'K'
...
C     ******************************************************************
     ...
     X           (BSQUARES(1,1,1),I2(1089)),(CONTROL(1,1,-16),I2(2113))
      ...
      T4=WGAME(INDEX+3)
C
C     WE HAD THE LETTER 'K' SOMEHOW SHOVED INTO WGAME(13) 
C     HOWEVER WE CAN NOT COMPARE AN INTEGER TO A LETTER
C     THEREFORE WE GO WITH THE OCTAL 0113 FOR ASCII 'K'
C     IF(T1.NE.'K') GO TO 50
      IF(T1.NE.O'113') GO TO 50
      CALL WKINGOO(*300)
      MNEXT=1
      GO TO 140
   50 IF(T1.NE.'Q') GO TO 60
      CALL WQUEENOO(*300)
      MNEXT=2
  140 WKCASTLE=.FALSE.
      WQCASTLE=.FALSE.
