...
$CC $CFLAGS $CPPFLAGS -c -o ../sysinfo/sysmem.o ../sysinfo/sysmem.c
$CC $CFLAGS $CPPFLAGS -c -o ../sysinfo/sysinfo.o ../sysinfo/sysinfo.c
$CC $CFLAGS $CPPFLAGS -c -o fp64_inexact.o fp64_inexact.c
$CC $CFLAGS $CPPFLAGS -o fp64_inexact fp64_inexact.o \
    ../sysinfo/sysinfo.o ../sysinfo/sysmem.o -lm 

ls -lapb --full-time fp* ../sysinfo/sysinfo.o ../sysinfo/sysmem.o
