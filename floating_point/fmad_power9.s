...
0:	addis 2,12,.TOC.-.LCF0@ha
	...
	stw %r7,368(%r31)
	.loc 1 82 20
	lwz %r7,.LC4-.LCTOC1(%r30)
	rldicl %r7,%r7,0,32
	mr %r6,%r8
	rldicr %r6,%r6,0,31
	or %r7,%r6,%r7
	mr %r8,%r7
	lwz %r7,.LC5-.LCTOC1(%r30)
	rldicl %r7,%r7,0,32
	sldi %r7,%r7,32
	mr %r6,%r8
	rldicl %r6,%r6,0,32
	or %r7,%r6,%r7
	mr %r8,%r7
	lwz %r7,.LC6-.LCTOC1(%r30)
	rldicl %r7,%r7,0,32
	mr %r6,%r9
	rldicr %r6,%r6,0,31
	or %r7,%r6,%r7
	mr %r9,%r7
	lwz %r7,.LC7-.LCTOC1(%r30)
	rldicl %r7,%r7,0,32
	sldi %r7,%r7,32
	mr %r6,%r9
	rldicl %r6,%r6,0,32
	...
	std %r9,8(%r7)
	.loc 1 83 20
	lwz %r9,.LC8-.LCTOC1(%r30)
	rldicl %r9,%r9,0,32
	mr %r8,%r10
	rldicr %r8,%r8,0,31
	or %r9,%r8,%r9
	mr %r10,%r9
	lwz %r9,.LC9-.LCTOC1(%r30)
	rldicl %r9,%r9,0,32
	sldi %r9,%r9,32
	mr %r8,%r10
	rldicl %r8,%r8,0,32
	or %r9,%r8,%r9
	mr %r10,%r9
	lwz %r9,.LC10-.LCTOC1(%r30)
	rldicl %r9,%r9,0,32
	mr %r8,%r11
	rldicr %r8,%r8,0,31
	or %r9,%r8,%r9
	mr %r11,%r9
	lwz %r9,.LC11-.LCTOC1(%r30)
	rldicl %r9,%r9,0,32
	sldi %r9,%r9,32
	mr %r8,%r11
	rldicl %r8,%r8,0,32
...
.L8:
	...
	nop
	fmr %f0,%f1
	.loc 1 266 18 is_stmt 0 discriminator 1
	fmr %f3,%f0
	fmr %f2,%f26
	fmr %f1,%f27
	bl fmaf
	...
	nop
	fmr %f0,%f1
	.loc 1 266 16 is_stmt 1 discriminator 4
	stfs %f0,336(%r31)
	.loc 1 268 5
	lfs %f0,336(%r31)
	mfvsrd %r9,%vs0
...
.L10:
	...
	nop
	fmr %f0,%f1
	.loc 1 278 18 is_stmt 0 discriminator 1
	fmr %f3,%f0
	fmr %f2,%f26
	fmr %f1,%f27
	bl fma
	...
	nop
	fmr %f0,%f1
	.loc 1 278 16 is_stmt 1 discriminator 4
	stfd %f0,344(%r31)
	.loc 1 280 5
	lfd %f0,344(%r31)
	mfvsrd %r9,%vs0
...
.L12:
	...
	fmr %f0,%f1
	fmr %f1,%f2
	.loc 1 289 19 is_stmt 0 discriminator 1
	fmr %f6,%f1
	fmr %f5,%f0
	fmr %f3,%f20
	fmr %f4,%f21
	...
	fmr %f0,%f1
	fmr %f1,%f2
	.loc 1 289 17 is_stmt 1 discriminator 4
	addi %r9,%r31,352
	stfd %f0,0(%r9)
	stfd %f1,8(%r9)
	.loc 1 291 5
...
.L14:
	...
	nop
	.loc 1 306 5
	ld %r3,.LC67-.LCTOC1(%r30)
	bl printf
	nop
	.loc 1 308 5
	ld %r3,.LC69-.LCTOC1(%r30)
	bl printf
	nop
	.loc 1 310 12
	li %r9,42
...
.LFE1:
	.size	endian,.-endian
.Letext0:
	.file 2 "/opt/gcc-14.2.0/lib/gcc/powerpc64le-linux-gnu/14.2.0/include/stddef.h"
...
.LASF12:
	.string	"double"
.LASF25:
	.string	"GNU C99 14.2.0 -m64 -mcpu=power9 -mfloat128-hardware -mfull-toc -mregnames -g -O0 -std=c99 -fno-builtin -fno-unsafe-math-optimizations -fno-fast-math"
.LASF29:
	.string	"main"
.LASF28:
	.string	"endian"
